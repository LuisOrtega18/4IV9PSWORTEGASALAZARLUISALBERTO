...
function problema3(){
     ...
     var smayor = "";
      ...
      for (var i = 0 ; i < arreglo.length ; i++){
        ...
        var valores = salida.split("|");
        var largo = parseInt(valores[0],10);
    ...
    document.querySelector("#p3-output").textContent = "Palabra con mas caracteres unicos: " + smayor;
 }
...
function Conteo(elemento){
     ...
     for (var i = 0 ; i < elemento.length ; i++){
         ...
         var caracteres = elemento.substr(i,1);
         console.log(caracteres);
         console.log(diccionario.has(caracteres));
         if(diccionario.has(caracteres) == false){
             diccionario.set(caracteres,caracteres);
             letras += caracteres + ",";
             contenido++;
         }
     }
  
     return contenido.toString() + "|" + letras;
 }
class Dictionary {
     constructor () {
       this.items = {}
